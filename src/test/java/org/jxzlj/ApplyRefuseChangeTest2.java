 ...
 * 变更质量官，市审核不通过流程
 */
public class ApplyRefuseChangeTest2 {
    ...
    @Test(testName ="登录市级市场监管局账号，市级审批不通过",priority = 12)
    //区县审核通过
    ...
    @Test(testName ="申请变更操作，市级审批不通过，登录省级账号，输入姓名，查询用户流转节点，验证流转节点是,已归档（不通过）",priority = 13)
    //查询
