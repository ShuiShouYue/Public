 ...
 * 注销质量官，市审核退回流程
 */
public class ApplyReturnCancleTest2 {
    ...
    @Test(testName ="申请注销操作，市级审批退回，登录省级账号，输入姓名，查询用户流转节点，验证流转节点是,市市场监管局审核退回",priority = 13)
    //查询
    ...
    @Test(testName ="质量官注销，市级审批退回，登录省级账号，输入姓名，查询用户证书状态，验证证书状态是是\"启用\"",priority = 14)
