...
public class ApplyTest3 {
    ...
    //市级审核通过
    public void audit_pass_shiTest() throws IOException {
    ...
    @Test(testName ="省级审批不通过",priority = 4)
    public void audit_refuse_shengTest() throws IOException {
