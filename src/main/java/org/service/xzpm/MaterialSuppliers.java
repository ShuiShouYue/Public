...
public class MaterialSuppliers {
    /**
     * 供应商新增
     */
    public String  save(String body) throws IOException {
        ...
        String url = BasePath_New_ZPM.ZPM_IP + BasePath_New_ZPM.SUPPLIERS_SAVE;
    ...
    public String  findPageByQuery(String body) throws IOException {
        Http http = new Http();
        String token = BaseConst_New_ZPM.Token_xzpm;
        String url = BasePath_New_ZPM.ZPM_IP + BasePath_New_ZPM.SUPPLIERS_FIND;
        String response = http.post(token,url,body);
        return response;
    }
