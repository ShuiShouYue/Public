...
public class BasePath_1 {
    ...
    //-------------------------------接口路径-------------------------------------
    //获取用户信息
    public static final String GET_CURRENT_USE ="/api/sys/captcha/getCurrentUser";
    //获取首页信息
    public static final String GET_COMPANY_INFO="/api/gm2d/company/findByUscc";
    //创建模板
